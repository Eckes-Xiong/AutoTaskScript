...
const jsons = [
    ...
    //{"act_id":"e202311201442471","region":"cn_gf01","uid":"236862991","lang":"zh-cn"},
]
const hs = [
    {
...
async function mihoyo_sign(i) {
  await new Promise(resolve => setTimeout(resolve, Math.random()*30000*(i+1)));
